...
import { collection, addDoc, Timestamp } from "firebase/firestore"; // Mudamos serverTimestamp para Timestamp
import {
  X,
  Tag,
  ArrowUpCircle,
...
export default function AddTransactionModal({ isOpen, onClose }: Props) {
  ...
  // ✅ Reset sempre que abrir (Coloca a data de hoje por padrão)
  useEffect(() => {
    if (isOpen) {
      setDescription("");
  ...
  // ✅ Fechar com ESC (Com proteção para o objeto window)
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Criamos um objeto Date a partir da string selecionada (garantindo meio-dia para evitar erros de fuso horário)
      ...
      await addDoc(collection(db, "transactions"), {
        ...
        type,
        // Usamos Timestamp.fromDate para salvar a data escolhida pelo usuário
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl text-3xl font-black text-slate-800 focus:ring-2 focus:ring-blue-500/20 outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl font-medium text-slate-700 focus:ring-2 focus:ring-blue-500/20 outline-none"
                  />
                </div>
              </div>
              ...
              {/* DATA (NOVO CAMPO) */}
              <div className="space-y-1">
                <label className="text-sm font-bold text-slate-700 ml-1">Data do Lançamento</label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl font-medium text-slate-700 focus:ring-2 focus:ring-blue-500/20 outline-none appearance-none"
                  />
                </div>
              </div>
